...
(custom-set-variables
 ...
 '(package-selected-packages
   '(alchemist autopair company company-ghc diminish dockerfile-mode drag-stuff editorconfig elm-mode emmet-mode ess evil evil-commentary evil-leader evil-matchit evil-org evil-search-highlight-persist evil-snipe evil-surround exec-path-from-shell expand-region fish-mode flycheck-cask flycheck-elm flycheck-ledger flycheck-rust ghc git-gutter helm helm-ag helm-dash helm-flycheck helm-projectile helm-swoop htmlize idle-highlight-mode js2-mode ledger-mode less-css-mode linum-relative lua-mode magit markdown-mode multiple-cursors neotree nyan-mode org pallet persp-projectile perspective php-mode popwin prodigy projectile puppet-mode rainbow-delimiters rainbow-mode rust-mode scss-mode smart-mode-line smartparens smex stylus-mode tide typescript-mode use-package web-mode yaml-mode yasnippet vue-mode))
